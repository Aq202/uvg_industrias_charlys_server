...
RETURNS TABLE(element VARCHAR(100), available FLOAT, required FLOAT, tipo TEXT) as
$BODY$
begin
   	return query
   	select coalesce(m.description, f.fabric) as "element", quantity as available,
		quantity_per_unit * q as required,
